...
## Behaviour
- All three inputs are controlled (value + onChange).
- fromDate and toDate default to today (YYYY-MM-DD) — set in parent, not here.
- stockExchange default "DSE" — set in parent.
- Fetch button disabled when loading, shows spinner text.
